...
export default class Speech {
    ...
    /**
     * Gets the currently active text-to-speech engine
     * @returns Promise<string> Resolves with the package name of the active engine, or empty string on iOS
     * @platform Android
     * @example
     * const activeEngine = await Speech.getActiveEngine();
     * console.log(activeEngine); // e.g. 'com.google.android.tts' or 'com.vivo.tts'
     */
    static getActiveEngine(): Promise<string>;
    /**
     ...
     * });
     */
    static initialize(options: VoiceOptions): void;
    /**
